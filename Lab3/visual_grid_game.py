...
class VisualGridHuntGame:
    ...
    def get_percept(self) -> dict:
        ...
        return {
            ...
            # Global state exposed for the Practical 03 SearchAgent.
    ...
    def execute_action(self, action: str):
        ...
        # Practical 03: direct grid movement actions used by SearchAgent.
        # These actions keep the search plan based on (x, y) coordinates.
...
class GridGameGUI:
    def __init__(
        ...
        self.root = root
        self.root.title(
            "IT3012 - Practical 03: Uninformed Search Agent"
        )
        ...
        # Change this to "DFS" or "UCS" to compare the algorithms.
            ...
            if not self.env.is_done():
                ...
                self.label.config(
                    text=(
                        ...
                        f"Plan remaining: {len(self.agent.plan)}"
                    )
                )
